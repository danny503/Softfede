	...
	<div class="full">
			<div class="menu"> <!-- MENU DEL COSTADO-->
				<ul>
					...
					<li><a href="/programacion"><div class="cat"><i class="contact"></i><i class="watching1"></i></div></a></li>
					<li><a href="reviews"><div class="cnt"><i class="contact"></i><i class="contact1"></i></div></a></li>
				</ul>
			</div>
		<div class="main">
      <!--FIN REPITE-->
